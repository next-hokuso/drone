...
namespace MainGame
{
    public class MGStickChallenge_Mediator
    {
        //================================================
        // [///]
        //================================================
        ...
        // ゲーム状態管理
        static public MGStickChallenge_GameStateCtrl StateCtrl { get; private set; } = null;
        // オブジェクト仲介
        static public MGStickChallenge_ObjMediator ObjMediator { get; private set; } = null;
        // キャンバス
        static public MGStickChallenge_CanvasCtrl MainCanvas { get; private set; } = null;
        ...
        // --- オペレーター --------------------------------------
        static public void SetGameStateCtrl(MGStickChallenge_GameStateCtrl _state)
        {
            StateCtrl = _state;
        }
        // --- オブジェクト仲介 -----------------------------
        static public void SetObjMediator(MGStickChallenge_ObjMediator _objMediator)
        {
            ObjMediator = _objMediator;
        }
        // --- キャンバス -----------------------------
        static public void SetCanvas(MGStickChallenge_CanvasCtrl _ctrl)
        {
            MainCanvas = _ctrl;
        }
