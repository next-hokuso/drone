...
/// </summary>
public class ChangeScene_StickChallenge : MonoBehaviour
{
    private string _sceneName = "Game_StickChallenge";
    ...
    public static void SetChangeScene()
    {
        ...
        go.AddComponent<ChangeScene_StickChallenge>();

        AppCommon.SetCurrentSceneName("Game_StickChallenge");
    }
    ...
    public IEnumerator Start()
    {
        ...
        // ↓ ここからScene処理
        // シーンスクリプトを付与
        MainGame.Game_StickChallengeBaseCtrl ctrl = appCtrl.AddComponent<MainGame.Game_StickChallengeBaseCtrl>();
        ...
        // シーン設定
        AppCommon.m_NowLoadSceneNo = (int)AppCommon.LoadSceneNo.Game_StickChallenge;
