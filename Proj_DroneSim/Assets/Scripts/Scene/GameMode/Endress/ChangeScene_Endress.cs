...
/// </summary>
public class ChangeScene_Endress : MonoBehaviour
{
    private string _sceneName = "Game_Endress";
    ...
    public static void SetChangeScene()
    {
        ...
        go.AddComponent<ChangeScene_Endress>();

        AppCommon.SetCurrentSceneName("Game_Endress");
    }
    ...
    public IEnumerator Start()
    {
        ...
        // ↓ ここからScene処理
        // シーンスクリプトを付与
        MainGame.Game_EndressBaseCtrl ctrl = appCtrl.AddComponent<MainGame.Game_EndressBaseCtrl>();
