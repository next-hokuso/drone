...
public class Drone_MGStickChallengeCtrl : DroneBase
{
    //=========================================================================
    //
    // [///] 
    ...
    {
        if (other.transform.CompareTag("StickChallenge"))
        {
            // アイテムの消去
            other.gameObject.SetActive(false);

            // リザルト呼び出し
            MainGame.MGStickChallenge_Mediator.MainCanvas.SetResult(0);
        ...
        {
            MGStickChallenge_Mediator.MainCanvas.GetTimerCtrl().AddTime_CountUp(10.0f);
