...
namespace MainGame
{
    ...
    /// 制御スクリプト：MainGame
    /// </summary>
    public class MainGameBaseCtrl : ShSceneBaseCtrl
    {
        //================================================
        // [///] 定義
        //================================================
        // シーン名
        public const string SceneName = "MainGame";
        // メインカメラ名
        ...
        // ゲーム状態管理
        private MG_GameStateCtrl m_StateCtrl = null;
        // オブジェクト管理
        ...
        public override IEnumerator ProcResourcesLoad()
        {
            ...
            {
                // state管理付与
                m_StateCtrl = gameObject.AddComponent<MG_GameStateCtrl>();
                MG_Mediator.SetGameStateCtrl(m_StateCtrl);
                // 配置ルート
                ...
                MG_Mediator.SetCamera(goCamera.transform.Find("ObjCamera").GetComponent<Camera>());
        ...
        private IEnumerator AddtiveScene()
        {
            ...
            // 
            //     // MG_Mediatorの設定
            //     MG_Mediator.SetTitleCanvas(canvasCtrl);
            // }
