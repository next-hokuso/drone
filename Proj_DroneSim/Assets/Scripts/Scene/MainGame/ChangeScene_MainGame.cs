...
/// </summary>
public class ChangeScene_MainGame : MonoBehaviour
{
    ...
    public static void SetChangeScene()
    {
        ...
        go.AddComponent<ChangeScene_MainGame>();

        AppCommon.SetCurrentSceneName("MainGame");
    }
    ...
    public IEnumerator Start()
    {
        ...
        // シーン設定
        AppCommon.m_NowLoadSceneNo = (int)AppCommon.LoadSceneNo.MainGame;
