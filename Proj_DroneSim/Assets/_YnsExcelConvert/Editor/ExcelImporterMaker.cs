...
public class ExcelImporterMaker : EditorWindow
{
    ...
    private static string s_key_prefix = "yurunyanko-importer-maker.";
    private static string s_folderPath = "Assets/_YnsExcelConvert/";
    ...
    void ExportEntity()
    {
        string templateFilePath = s_folderPath + ((sepalateSheet) ? "Editor/EntityTemplate2.txt" : "Editor/EntityTemplate.txt");
        ...
        Directory.CreateDirectory(s_folderPath+"Classes/");
        File.WriteAllText(s_folderPath+"Classes/" + className + ".cs", entittyTemplate);
    }
	
    void ExportImporter()
    {
        string templateFilePath = s_folderPath + ((sepalateSheet) ? "Editor/ExportTemplate2.txt" : "Editor/ExportTemplate.txt");
        ...
        Directory.CreateDirectory(s_folderPath+"Classes/Editor/");
        File.WriteAllText(s_folderPath+"Classes/Editor/" + fileName + "_importer.cs", importerTemplate);
    }
