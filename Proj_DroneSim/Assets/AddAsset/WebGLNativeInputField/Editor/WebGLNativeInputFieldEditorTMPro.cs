...
[CustomEditor(typeof(WebGLNativeInputFieldTMPro))]
public class WebGLNativeInputFieldEditorTMPro : TMP_InputFieldEditor
{
    ...
    {
        WebGLNativeInputFieldTMPro dialog = target as WebGLNativeInputFieldTMPro;
        serializedObject.Update();
        EditorGUILayout.PropertyField(m_DialogType);
        EditorGUILayout.PropertyField(m_DialogTitle);
        if (dialog.m_DialogType == WebGLNativeInputFieldTMPro.EDialogType.OverlayHtml)
        {
